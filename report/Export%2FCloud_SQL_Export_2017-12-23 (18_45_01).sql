...
INSERT INTO `board` VALUES (0,'kingroma','2017-11-20 18:57:25',0,'','','안녕하세요.',0,0,'normal'),(1,'kingroma','2017-11-20 18:57:36',0,'','','토이스토리',0,0,'normal'),(2,'kingroma','2017-11-20 20:08:33',0,'','','test',0,0,'normal');
...
--
-- Table structure for table `board_good_bad`
--

DROP TABLE IF EXISTS `board_good_bad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `board_good_bad` (
  `board_number` int(11) DEFAULT NULL,
  `buyer_id` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `board_good_bad`
--

LOCK TABLES `board_good_bad` WRITE;
/*!40000 ALTER TABLE `board_good_bad` DISABLE KEYS */;
/*!40000 ALTER TABLE `board_good_bad` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `board_image` VALUES (0,0,'http://dj5427.cafe24.com/temp/kingroma_2017-11-20 18:57:23_trans59.jpg'),(1,0,'http://dj5427.cafe24.com/temp/kingroma_2017-11-20 18:57:35_toystory1.jpg');
...
CREATE TABLE `buyer` (
  ...
  `status` varchar(20) DEFAULT 'normal',
  `pw_hint` varchar(50) DEFAULT NULL,
  `pw_hint_answer` varchar(50) DEFAULT NULL,
  `address` varchar(50) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `name` varchar(20) DEFAULT NULL,
  `cash1` int(11) DEFAULT '0',
  `cash2` int(11) DEFAULT '0',
...
INSERT INTO `buyer` VALUES ('kingroma','4235',NULL,NULL,NULL,'normal',NULL,NULL,NULL,NULL,'김정진',0,0,0,1,NULL,NULL,NULL);
/*!40000 ALTER TABLE `buyer` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `buyer_board_good_bad`
--

DROP TABLE IF EXISTS `buyer_board_good_bad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `buyer_board_good_bad` (
  `buyer_id` varchar(20) DEFAULT NULL,
  `board_number` int(11) DEFAULT NULL,
  `value` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `buyer_board_good_bad`
--

LOCK TABLES `buyer_board_good_bad` WRITE;
/*!40000 ALTER TABLE `buyer_board_good_bad` DISABLE KEYS */;
/*!40000 ALTER TABLE `buyer_board_good_bad` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `buyer_product_good_bad`
--

DROP TABLE IF EXISTS `buyer_product_good_bad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `buyer_product_good_bad` (
  `buyer_id` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `buyer_product_good_bad`
--

LOCK TABLES `buyer_product_good_bad` WRITE;
/*!40000 ALTER TABLE `buyer_product_good_bad` DISABLE KEYS */;
/*!40000 ALTER TABLE `buyer_product_good_bad` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `followseller`
--

DROP TABLE IF EXISTS `followseller`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `followseller` (
  `buyer_id` varchar(20) DEFAULT NULL,
  `seller_id` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `followseller`
--

LOCK TABLES `followseller` WRITE;
/*!40000 ALTER TABLE `followseller` DISABLE KEYS */;
INSERT INTO `followseller` VALUES ('kingroma','kingroma');
/*!40000 ALTER TABLE `followseller` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `product` VALUES (0,'kingroma','2017-11-16 06:27:33',3,'stop','바꾸기','바꿈','','http://dj5427.cafe24.com/temp/2017-11-16 06:27:33_kingroma_kau9.jpg',1,3,0),(1,'kingroma','2017-11-16 21:48:55',5,'normal','tes입니다!','김정진2ㄷㅅㄷㅅㄴㄷㅅㄴㄷㅅㄴㄷㅅ','','http://dj5427.cafe24.com/temp/2017-11-17 20:22:45_kingroma_search_btn.png',5,0,0),(2,'kingroma','2017-11-17 19:23:55',0,'normal','ㅁㄴㄹㅇㄹㄴㅇㅁ','ㄹㅇㅁㄴㄴㄹㅇ','','',0,0,0);
...
--
-- Table structure for table `product_good_bad`
--

DROP TABLE IF EXISTS `product_good_bad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_good_bad` (
  `product_number` int(11) DEFAULT NULL,
  `buyer_id` varchar(20) DEFAULT NULL,
  `value` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `product_good_bad`
--

LOCK TABLES `product_good_bad` WRITE;
/*!40000 ALTER TABLE `product_good_bad` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_good_bad` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `product_image` VALUES (-1,0,'http://dj5427.cafe24.com/temp/2017-11-16 06:09:48_detail_0kau12.jpg'),(-1,0,'http://dj5427.cafe24.com/temp/2017-11-16 06:12:09_detail_0kau13.jpg'),(1,0,'http://dj5427.cafe24.com/temp/2017-11-17 20:22:45_detail_0KakaoTalk_20171115_110811590.jpg'),(1,1,'http://dj5427.cafe24.com/temp/2017-11-17 20:22:45_detail_1search_btn2.png');
...
INSERT INTO `product_option` VALUES (-1,'옵션1',0,303030,'normal'),(-1,'test',0,3030,'normal'),(1,'test1',0,2123,'normal'),(1,'test2',1,3423,'normal');
...
INSERT INTO `seller` VALUES ('dj5427','dj5427','박동준','',NULL,'','normal','','','','',1,'http://dj5427.cafe24.com/temp/dj5427_IMG_2054.JPG','정진 개고수','','','2017-11-20 01:01:39'),('kingroma','4235','김정진','',NULL,'','normal','','','','',1,'http://dj5427.cafe24.com/temp/kingroma_kau7.jpg','김정진','','','2017-11-15 00:16:07'),('mynameis','4235','4235','',NULL,'','normal','','','','',1,'http://dj5427.cafe24.com/temp/mynameis_kau6.jpg','4235','','','2017-11-14 23:47:05');
...
INSERT INTO `student` VALUES ('dfkj','dfkj','asdkfj');
/*!40000 ALTER TABLE `student` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Current Database: `mvc_test`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `mvc_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2017-12-21 07:07:14',NULL),('diagnostics.include_raw','OFF','2017-12-21 07:07:14',NULL),('ps_thread_trx_info.max_length','65535','2017-12-21 07:07:14',NULL),('statement_performance_analyzer.limit','100','2017-12-21 07:07:14',NULL),('statement_performance_analyzer.view',NULL,'2017-12-21 07:07:14',NULL),('statement_truncate_len','64','2017-12-21 07:07:14',NULL);
...
-- Dump completed on 2017-12-23  9:45:21
